...
wide_dt <- fread("legacy/Inputs/GLEAM_input_preproc.csv")
wide_camels_dt <- fread("legacy/Inputs/Pre_processing/Camelids/camels_inputs.csv")
...
fwrite(wide_dt[Animal_short!="CHK",], "legacy/Inputs/GLEAM_input_herd.csv")
