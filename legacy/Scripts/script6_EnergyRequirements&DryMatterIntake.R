...
## energy for working
GLEAM_input_energyrequirement[, nework := Dfunction_nework(
  Animal_short, cohort, nemain,
  work_hours, draught_fraction
), by = seq_len(nrow(GLEAM_input_energyrequirement))]



## energy for fiber production
GLEAM_input_energyrequirement[, nefibre := Dfunction_nefibre(
  Animal_short, cohort, fibre_prod
), by = seq_len(nrow(GLEAM_input_energyrequirement))]
...
## energy for rem
GLEAM_input_energyrequirement[, rem := Dfunction_rem(
  Animal_short, diet_dig
), by = seq_len(nrow(GLEAM_input_energyrequirement))]


## energy for reg
GLEAM_input_energyrequirement[, reg := Dfunction_reg(
  Animal_short, diet_dig
), by = seq_len(nrow(GLEAM_input_energyrequirement))]

## total energy
GLEAM_input_energyrequirement[, getot := Dfunction_getot(
  Animal_short, cohort, nemain, neact,
  nelact, nework, nepreg, rem, negrow,
  nefibre, neegg, reg, diet_dig, afc
), by = seq_len(nrow(GLEAM_input_energyrequirement))]
...
GLEAM_input_energyrequirement[, dmi := Dfunction_dmi(
