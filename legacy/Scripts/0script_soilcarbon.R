...
# read parameters
soil_type_params <- fread("inst/extdata/SoilCarbon_parameters/soc_socref_soiltype.csv")
management_params <- fread("inst/extdata/SoilCarbon_parameters/soc_factor_management.csv")
luc_factors <- fread("inst/extdata/SoilCarbon_parameters/soc_luc_factor.csv")

# Functions
source("legacy/Functions/0_functions_soilcarbon.R")
