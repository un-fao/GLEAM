...
test_that("calc_ch4_manure computes methane by MMS group", {
  volatile_solids <- 2
  ratio <- 0.67
  mms_burned <- c(
...
test_that("calc_ch4_manure errors when MMS fractions do not sum to 1", {
  expect_error(
    calc_ch4_manure(
      volatile_solids = 1,
      mms_pasture = c(
...
# ---- test calc_ch4_manure edge cases ----
test_that("calc_ch4_manure validates MMS inputs", {
  expect_error(calc_ch4_manure(volatile_solids = 1, mms_pasture = c(
...
test_that("calc_n2o_manure_direct computes direct N2O by MMS group", {
  n_excretion <- 0.9
...
# ---- test calc_n2o_manure_direct edge cases ----
test_that("calc_n2o_manure_direct validates MMS inputs", {
  expect_error(calc_n2o_manure_direct(nitrogen_excretion = 0.9, mms_pasture = c(
...
test_that("calc_n2o_manure_volatilization computes indirect N2O by MMS group", {
  n_excretion <- 0.9
...
test_that("calc_n2o_manure_volatilization validates MMS inputs", {
  expect_error(calc_n2o_manure_volatilization(nitrogen_excretion = 0.9, mms_pasture = c(
...
test_that("calc_n2o_manure_leaching computes indirect N2O by MMS group", {
  n_excretion <- 0.9
  mms_burned <- c(manure_management_system_fraction = 0.2,
...
test_that("calc_n2o_manure_leaching validates MMS inputs", {
  expect_error(calc_n2o_manure_leaching(nitrogen_excretion = 0.9, mms_pasture = c(
