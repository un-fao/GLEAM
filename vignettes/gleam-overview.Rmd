...
```{r, echo=FALSE, eval = TRUE, out.width="90%", fig.cap="Overview of the GLEAM pipeline wih the different modules"}
knitr::include_graphics("images/gleamx_package_module_pipeline.png")
```
