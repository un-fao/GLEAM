---
title: "GLEAM R Package Modules"
subtitle: "An overview of Modules in the Global Livestock Environmental Assessment Model (GLEAM-X)"
...
pipeline is provided in the [GLEAM Overview vignette](gleam-overview.html). Full
...
<img src="images/gleamx_package_module_herd.png"
     ...
     style="width:70%; height:auto; cursor:zoom-in; transition:transform 0.25s ease; transform-origin:center;"
     onclick="
