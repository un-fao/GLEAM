...
```{r, echo=FALSE, eval = TRUE, out.width="90%", fig.cap="Overview of the GLEAM herd module with functions, input and output"}
knitr::include_graphics("images/gleamx_package_module_herd.png")
```
...
```{r, echo=FALSE, eval = TRUE, out.width="90%", fig.cap="Overview of the GLEAM weights module with functions, input and output"}
knitr::include_graphics("images/gleamx_package_module_weights.png")
```
...
```{r, echo=FALSE, eval = TRUE, out.width="90%", fig.cap="Overview of the GLEAM ration quality module with functions, input and output"}
knitr::include_graphics("images/gleamx_package_module_feedrations.png")
```
...
```{r, echo=FALSE, eval = TRUE, out.width="90%", fig.cap="Overview of the GLEAM metabolic energy requirements module with functions, input and output"}
knitr::include_graphics("images/gleamx_package_module_energyrequirements.png")
```
...
```{r, echo=FALSE, eval = TRUE, out.width="90%", fig.cap="Overview of the GLEAM enteric emissions module with functions, input and output"}
knitr::include_graphics("images/gleamx_package_module_enteric.png")
```
...
```{r, echo=FALSE, eval = TRUE, out.width="90%", fig.cap="Overview of the GLEAM nitrogen balance module with functions, input and output"}
knitr::include_graphics("images/gleamx_package_module_nitrogen.png")
```
...
```{r, echo=FALSE, eval = TRUE, out.width="90%", fig.cap="Overview of the GLEAM manure emissions module with functions, input and output"}
knitr::include_graphics("images/gleamx_package_module_manure.png")
```
...
```{r, echo=FALSE, eval = TRUE, out.width="90%", fig.cap="Overview of the GLEAM feed production emissions module with functions, input and output"}
knitr::include_graphics("images/gleamx_package_module_feedemissions.png")
```
...
```{r, echo=FALSE, eval = TRUE, out.width="90%", fig.cap="Overview of the GLEAM production module with functions, input and output"}
knitr::include_graphics("images/gleamx_package_module_production.png")
```
...
```{r, echo=FALSE, eval = TRUE, out.width="90%", fig.cap="Overview of the GLEAM emission allocation module with functions, input and output"}
knitr::include_graphics("images/gleamx_package_module_allocation.png")
```
...
```{r, echo=FALSE, eval = TRUE, out.width="90%", fig.cap="Overview of the GLEAM aggregation and reporting module with functions, input and output"}
knitr::include_graphics("images/gleamx_package_module_aggregation.png")
```
