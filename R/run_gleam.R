...
#'
#' @examples
#' # Example 1: run pipeline when you don't have herd structure, so it will be generated by the herd simulation module
#' \dontrun{
...
#' }
#'
#' # Example2: run pipeline when you already have cohort-level herd structure, so you can skip the herd simulation module
#' \dontrun{
