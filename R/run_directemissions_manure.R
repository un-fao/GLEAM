...
#'   and other), consistently with Equation 10.23 (IPCC, 2006, 2019).
...
#'   by MMS group, consistently with Equation 10.25 (IPCC, 2006, 2019).
...
#'     10.27 (IPCC, 2019), and 10.29 (IPCC, 2006, 2019).
#'   }
