...
#' \enumerate{
#'   \item Daily nitrogen intake is computed using \code{\link{compute_nitrogen_intake}}
#'   from \code{dry_matter_intake} and \code{diet_nitrogen}.
#'   \item Daily nitrogen retention is computed using \code{\link{compute_nitrogen_retention}}
